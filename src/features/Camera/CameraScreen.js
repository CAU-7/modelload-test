...
import ObjectDetection from './ObjectDetection'; // ObjectDetection.js
        ...
        {detectedObjects.map((obj, index) => (
          <View
            ...
            style={[
              styles.bbox,
              {
                left: obj.bbox[0] * (device.photoWidth / 320),
                top: obj.bbox[1] * (device.photoHeight / 320),
                width: obj.bbox[2] * (device.photoWidth / 320),
                height: obj.bbox[3] * (device.photoHeight / 320),
              },
            ]}>
